...
EcoMobs lets you build fully custom mobs from simple config files. You control every part of a mob: its base type and stats, equipment, drops, effects, boss bars, and how it spawns. Mobs can replace vanilla spawns, appear through your own spawning system, or be summoned with spawn eggs and totems.

## What sets EcoMobs apart?
